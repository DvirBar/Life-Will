...
import translation, { answers, inheritorsTypes } from '../../../store/translation'
...
function Step3RealEstate() {
    const numItems = data.real_estate_data.length
    return (
        <>
            {data.real_estate === answers.yes && data.real_estate_data.map((reItem, index) =>
                <Block>
