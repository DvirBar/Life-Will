...
export default function StepFourTool({ values, next, prev }) {
    ...
    return (
        <>
            <div role="group">
                ...
                <div className="status-group flex space-between input-btn">
                    <label className={`${values.values.tool === "לא" ? 'active' : ''}`}>
                        <Field type="radio" name="tool" value="לא" />
                        לא
                    </label>
                    <label className={`${values.values.tool === "כן" ? 'active' : ''}`}>
                        <Field type="radio" name="tool" value="כן" />
                        כן
                    </label>
                </div>
            </div>
            {values.values.tool === 'כן' &&
