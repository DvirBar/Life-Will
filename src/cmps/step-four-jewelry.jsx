...
export default function StepFourJewelry({ values, next, prev }) {
    ...
    return (
        <>
            <div role="group">
                ...
                <div className="status-group flex space-between input-btn">
                    <label className={`${values.values.jewelry === "לא" ? 'active' : ''}`}>
                        <Field type="radio" name="jewelry" value="לא" />
                        לא
                    </label>
                    <label className={`${values.values.jewelry === "כן" ? 'active' : ''}`}>
